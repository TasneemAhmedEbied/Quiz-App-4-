...
import 'package:quiz_app/core/resources/assets_value_manager.dart';
...
import 'package:quiz_app/model/onbourding_pages_model.dart';
          ...
          builder: (context, asyncSnapshot) {
            ...
            return Column(
              children: [
                ...
                Padding(
                  padding: EdgeInsetsGeometry.symmetric(horizontal: PaddingManager.p30),
                  child: Row(
